...
<body class="yellow-bg">
    ...
    <main>
        <a href="<?php echo $base_url; ?>/index.php" class="link-substructure">Home</a> > <a href="#" class="link-substructure"> Information</a>  > <a href="darthvader.php" class="link-substructure">Darth Vader</a> 
        <div class="wrapper">
