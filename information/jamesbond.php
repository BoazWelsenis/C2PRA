...
<head>
    ...
    <title>C2 CodeCamp - James Bond</title>
</head>
<body>
    <?php 
    ...
    <main>
        <a href="<?php echo $base_url; ?>/index.php" class="link-substructure">Home</a> > <a href="<?php echo $base_url; ?>/information/informatie.php" class="link-substructure"> Informatie</a>  > <a href="jamesbond.php" class="link-substructure">James Bond</a> 
        <div class="wrapper">
        <h1>Lijst van James Bond films met Roger Moore</h1>
            <ul>
                <div class="grid">
                    <div class="film-item"><li><a href="https://www.imdb.com/title/tt0070328/">Live and Let Die</a><a href="https://www.imdb.com/title/tt0070328"><img src="../img/James-bond-covers/live-and-let-die.jpg" alt="Cover"></a></li></div>
                    <div class="film-item"><li><a href="https://www.imdb.com/title/tt0071807/?ref_=nv_sr_srsg_0">The Man with the Golden Gun</a><a href="https://www.imdb.com/title/tt0071807/?ref_=nv_sr_srsg_0"><img src="../img/James-bond-covers/the-man-with-the-golden-gun.jpg" alt="Cover"></a></li></div>
