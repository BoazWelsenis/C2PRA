...
<head>
    ...
    ?>
<body class="red-bg">
<a href="<?php echo $base_url; ?>/index.php" class="link-substructure">Home</a> > <a href="#" class="link-substructure"> Songteksten</a>  > <a href="redmusic.php" class="link-substructure">Rood</a> 
    <div class="wrapper">
